...
$pgv_lang["TBLPREFIX_help"]		= "Ein Prefix der an die Tabellen angehängt wird, die von PhpGedView erstellt werden. Durch Ändern dieses Wertes können Sie mehrere PhpGedView-Sites bestimmen, die die gleiche Datenbank jedoch unterschiedliche Tabellen benutzen.<br />Diese Einstellung verändert die Variable \PHPGEDVIEW_DB_PREFIX in der Datei \"config.php\".";
