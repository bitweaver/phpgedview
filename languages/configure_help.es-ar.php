...
$pgv_lang["TBLPREFIX_help"] = "Un prefijo para añadir a los nombres de las tablas MySQL creadas por PhpGedView. Cambiando este valor puede gestionar múltiples sitios PhpGedView y utilizar la misma base de datos pero con diferentes tablas.<br>Modifica la variable \PHPGEDVIEW_DB_PREFIX en el archivo config.php.";
