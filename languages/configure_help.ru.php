...
$pgv_lang["TBLPREFIX_help"]		= "Префикс (титул) для таблиц MySQL, созданных PhpGedView. Изменив это значение, Вы можете использовать несколько PhpGedView сайтов одной базы данных, но различные таблицы. Это находится в переменной \PHPGEDVIEW_DB_PREFIX файла config.php.";
