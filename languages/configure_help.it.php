...
$pgv_lang["TBLPREFIX_help"] = "A prefix to append to the MySQL tables created by PhpGedView.  By changing this value you can setup multiple PhpGedView sites to use the same database but different tables.  This sets the \PHPGEDVIEW_DB_PREFIX variable in the config.php file.";
