...
$pgv_lang["TBLPREFIX_help"] 		= "~#pgv_lang[TBLPREFIX]#~<br/><br/>Az előtag, melyet a PhpGedView az adattáblák nevéhez fűz. A mező tartalmának megváltoztatásával Ön több PhpGedView-oldalt üzemeltethet azonos adatbázissal, de eltérő adattáblákkal.<br/><br/>Ez a mező beállítja a \PHPGEDVIEW_DB_PREFIX változót a <i>config.php</i> állományban.<br/>";
