...
$pgv_lang["TBLPREFIX_help"]         = "Un prefijo para añadir a las tablas MySQL creadas por PhpGedView.  Cambiando este valor puede gestionar múltiples sitios PhpGedView, y utilizar la misma base de datos pero con diferentes tablas.  Esto cambia la variable \PHPGEDVIEW_DB_PREFIX en el archivo config.php.";
