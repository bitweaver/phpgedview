...
$pgv_lang["SHOW_MULTISITE_SEARCH_help"]	= "~#pgv_lang[SHOW_MULTISITE_SEARCH]#~<br /><br />The multi-site search allows users to search across mutliple PhpGedView websites which you have setup in the Manage Sites administration area or remotely linked to.  You wouldn't normally want to open this up to your public site visitors, but you may want to provided it to your authenticated users or administrators.";
...
$pgv_lang["um_sql_index"] = "This tool will create <i>authenticate.php</i> and several <i>.dat</i> files in your index directory.<br /><br />After successful creation, you can switch to Index mode with all current users and their messages, favorites, and MyGedview layout available.<br /><br />Note: After switching to Index mode, you will need to import your GEDCOM files again.<br />";
...
$pgv_lang["type_book"] = "Book";
$pgv_lang["type_card"] = "Card";
$pgv_lang["type_electronic"] = "Electronic";
$pgv_lang["type_fiche"] = "Fiche";
$pgv_lang["type_film"] = "Film";
$pgv_lang["type_magazine"] = "Magazine";
$pgv_lang["type_manuscript"] = "Manuscript";
$pgv_lang["type_map"] = "Map";
$pgv_lang["type_newspaper"] = "Newspaper";
$pgv_lang["type_photo"] = "Photo";
$pgv_lang["type_tombstone"] = "Tombstone";
